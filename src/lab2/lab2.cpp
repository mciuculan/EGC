...
void Lab2::Init()
{
    ...
    // Create a mesh box using custom data
    {
        ...
        vector<VertexFormat> verticesTetraedru {
            VertexFormat(glm::vec3(0, 0,  0), glm::vec3(0, 1, 1)),
            VertexFormat(glm::vec3(3, 0,  5), glm::vec3(0, 1, 1)),
            VertexFormat(glm::vec3(4, 1,  0), glm::vec3(0, 1, 1)),
            VertexFormat(glm::vec3(0, 3,  4), glm::vec3(0, 1, 1))
        };

        vector<VertexFormat> verticesPatrat{
        ...
        vector<unsigned int> indexesTetraedru =
        {
            0, 1, 2,
            1, 3, 2,
            0, 3, 1,
        ...
        vector<unsigned int> indexesPatrat =
        {
            2, 1, 0,
            2, 3, 0
        };
        ...
        CreateMesh("tetraedru", verticesTetraedru, indexesTetraedru);
        CreateMesh("patrat", verticesPatrat, indexesPatrat);
    }
...
void Lab2::Update(float deltaTimeSeconds)
{
    ...
    RenderMesh(meshes["tetraedru"], shaders["VertexColor"], glm::vec3(1.0f, 1.0f, 1), glm::vec3(0.25f));
