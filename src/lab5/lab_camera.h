    ...
    class Camera
    {
     public:
        ...
        void RotateFirstPerson_OX(float angle)
        {
            ...
            glm::vec4 ox = glm::rotate(glm::mat4(1), angle, right) * glm::vec4(forward, 0);
            forward = glm::normalize(glm::vec3(ox));
        ...
        void RotateFirstPerson_OY(float angle)
        {
            ...
            // vectors!
            glm::vec4 oy = glm::rotate(glm::mat4(1), angle, glm::vec3(0, 1, 0)) * glm::vec4(forward, 0);
            forward = glm::normalize(glm::vec3(oy));
            oy = glm::rotate(glm::mat4(1), angle, glm::vec3(0, 1, 0)) * glm::vec4(right, 0);
            right = glm::normalize(glm::vec3(oy));
            up = glm::cross(right, forward);
        }
        ...
        void RotateFirstPerson_OZ(float angle)
        {
            ...
            glm::vec4 oz = glm::rotate(glm::mat4(1.f), angle, glm::vec3(0, 1, 0)) * glm::vec4(right, 1);
            right = glm::normalize(glm::vec3(oz));
            oz = glm::rotate(glm::mat4(1.f), angle, forward) * glm::vec4(up, 0);
            forward = glm::normalize(glm::vec3(oz));
            up = glm::cross(right, forward);
        }
