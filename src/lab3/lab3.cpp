...
void Lab3::Update(float deltaTimeSeconds)
{
    ...
    if (noFrames < 110) {
        ...
        RenderMesh(meshes["square1"], shaders["VertexColor"], glm::vec3(translateX, translateY, 0));
    }
    ...
    if (noFrames < 300) {
        ...
        modelMatrix *= transform2D::Translate(400, 250) * transform2D::Scale(scaleX, scaleY);
        RenderMesh2D(meshes["square2"], shaders["VertexColor"], modelMatrix);
    } else {
        RenderMesh(meshes["square2"], shaders["VertexColor"], glm::vec3(cx, cy, 0));
    }
